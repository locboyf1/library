			...
			<div class="login-wrapper">
				<div class="login-left">
					<a th:href="@{/}" class="logo"><img
						th:src="@{/assets/img/home-two/logo-dark.svg}" alt="Image"></a>
					<h2 class="title">Sign Up to Bookjar</h2>
					<div class="sibtitle">Create Your Account with Just Few Steps</div>

					<div class="social-links">
						<a href="#"><img th:src="@{/assets/img/login/google-icon.svg}"
							alt="Image"></a> <a href="#"><img
							th:src="@{/assets/img/login/fb-icon.svg}" alt="Image"></a> <a
							href="#"><img th:src="@{/assets/img/login/apple-icon.png}"
							alt="Image"></a>
					</div>
					<div class="divider">
						<span>or</span>
					...
					<form th:action="@{/register}" th:object="${user}" method="post">
						...
						<div class="input-field pass-field-with-icon">
							<input type="password" name="matKhau" class="form-control"
								id="toggle_passowrd_field" placeholder="Mật khẩu"> <i
						...
						<div class="d-flex justify-content-between input-field">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" value=""
									...
									for="flexCheckChecked"> I Agreed with the <a
									th:href="@{/privacy-policy}">Privacy policy</a>
								</label>
							</div>
						</div>
				...
				<div class="login-right">
					<img class="mt-auto"
						th:src="@{/assets/img/login/reginstration-img.png}" alt="Image">
				</div>
			</div>
		</div>
	</div>
