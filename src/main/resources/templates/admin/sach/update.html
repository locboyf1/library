						...
						<form class="card-body" th:object="${sach}" method="post"
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label>Ảnh bìa (Không chọn nếu muốn giữ ảnh cũ)</label> <input
											type="file" name="fileAnhBia" class="form-control"
											id="fileAnhBia">
										<div class="text-danger"
											th:if="${#fields.hasErrors('anhBia')}" th:errors="*{anhBia}"></div>

										<img id="anhBiaPreview" th:src="${sach.anhBia}	"
